#ifndef _significant_interval_search_meta_cmh_no_heuristic_c_
#define _significant_interval_search_meta_cmh_no_heuristic_c_
...
unsigned long long *bitmasks; //bitmasks[k] = 2^k
...
void sis_init(char *X_filename, char *Y_filename, char *C_filename, double target_fwer, long long l_max){
	...
	// Vector of bitmasks for enumerating all 2^K subsets of a vector of dimension K
...
int isprunable(long long*x){
	...
	return Chi2_sf(Tcmh_max_corner_l,1) > pth;
}
